              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${errors.companyName ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${errors.industry ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., 200"
                    min="1"
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${errors.companySize ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${errors.valuePropositionKeywords ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${errors.targetRegions ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${criteriaErrors.industry ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., 10"
                    min="1"
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${criteriaErrors.minSize ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., 500"
                    min="1"
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${criteriaErrors.maxSize ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 ${criteriaErrors.regions ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                      }`}
                  />
                    ...
                    return (
                      <tr key={prospect.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4">
                          <span className={`px-2 py-1 rounded text-xs font-semibold ${score >= 70 ? 'bg-green-100 text-green-800' :
